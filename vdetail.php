...
$recordperpage = 6;
	...
	$query= "SELECT * FROM `videos` where video_id=".$_GET['videoid'];
...
<html lang="en">
  <head>
    <title>Bayelsa State Covid-19 Library -  <?php echo $connect->show_video_title($_GET['videoid']);?></title>
    <meta charset="utf-8">
...
<div style="margin-top:-120px">
         ...
         <?php }?> <!-- .col-md-8 -->
          <div class="col-lg-4 sidebar ftco-animate">
            ...
            <?php include('includes/all_videos.php'); ?>
            </div>
